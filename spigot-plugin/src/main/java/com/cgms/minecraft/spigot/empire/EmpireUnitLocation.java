...
public class EmpireUnitLocation implements Serializable
{
    ...
    public EmpireUnitLocation()
    {
    }

    public EmpireUnitLocation( String worldName, double x, double y, double z )
    {
        this.locationX = x;
        this.locationY = y;
        this.locationZ = z;
    ...
    public EmpireUnitLocation( Block block )
    {
    ...
    public EmpireUnitLocation( Location location )
    {
        this.locationX = location.getX();
        this.locationY = location.getY();
        this.locationZ = location.getZ();
    ...
    public boolean equals( Object o )
    {
        ...
        EmpireUnitLocation that = (EmpireUnitLocation) o;
